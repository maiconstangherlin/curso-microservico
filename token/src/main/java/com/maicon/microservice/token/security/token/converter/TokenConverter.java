package com.maicon.microservice.token.security.token.converter;
...
public class TokenConverter {
    ...
    public void validateTokenSignature(String signedToken) {
        log.info("Starting methot to validate token signature");

        SignedJWT signedJWT = SignedJWT.parse(signedToken);

        log.info("Token parsed! Retrieving key from signed token");
